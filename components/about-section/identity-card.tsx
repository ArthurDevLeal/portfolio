    ...
    <div className="mt-12 sm:mt-16 md:mt-24">
      <div className="grid grid-cols-2 gap-2 sm:gap-3 md:grid-cols-6 md:gap-4">
          ...
          <div className="flex h-full flex-col justify-between gap-4 sm:gap-6">
            <div className="flex items-center gap-2 text-muted-foreground">
              <Radio
                ...
                aria-hidden
              />
              <span className="font-mono text-[9px] tracking-[0.22em] uppercase sm:text-[10px]">
                ao vivo
              </span>
              <span
                aria-hidden
            ...
            <div>
              <p
                className="font-sans text-2xl leading-[1.1] font-medium tracking-tight text-balance text-foreground sm:text-4xl sm:leading-[1.05] md:text-5xl lg:text-6xl"
                aria-live="polite"
              >
                {time}
              </p>
              <p className="mt-2 font-mono text-[9px] tracking-[0.18em] text-muted-foreground uppercase sm:mt-3 sm:text-[11px]">
        ...
        >
          ...
          <p className="mt-1 font-mono text-[9px] tracking-[0.18em] text-muted-foreground uppercase sm:text-[10px]">
            -15.24, -40.24
          </p>
        </Cell>
      </div>
...
function Cell({
  ...
  return (
    <div
      className={`group relative flex min-h-32 flex-col justify-between rounded-md border border-border bg-card p-3 transition-colors hover:border-foreground/30 sm:min-h-35 sm:p-5 ${className}`}
    >
      <div className="flex items-center gap-2 font-mono text-[9px] tracking-[0.22em] text-muted-foreground uppercase sm:text-[10px]">
